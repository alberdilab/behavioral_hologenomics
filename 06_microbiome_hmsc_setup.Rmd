...
```{r hmsc_input, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r hmsc_formulas, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r hmsc_models, warning=FALSE, comments="", message=FALSE, eval=FALSE}
#Define models
model1 = Hmsc(Y= YData,
         XData = XData,
         XFormula = XFormula1,
...
```{r hmsc_mcmc, warning=FALSE, comments="", message=FALSE, eval=FALSE}
