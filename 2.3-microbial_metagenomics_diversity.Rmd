---
title: "2.3-microbial_metagenomics_diversity"
...
```{r alpha_di_plot, message=FALSE, warning=FALSE, fig.height=10, fig.width=10, fig.fullwidth=TRUE}
#Plot diversities
alpha_plot_neutral <- alpha_div %>%
        ...
        filter(!is.na(animal)) %>%
          ggplot(aes(x=value, y=sample)) +
            ...
            facet_nested(group + cage + animal ~ data,  scales="free") + #facet per treatment and animal
...
```{r beta_div, message=FALSE, warning=FALSE}
